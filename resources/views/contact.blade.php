...
<body style="background-image: linear-gradient(90deg, #b743ae, #ed429e);">
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-md-10">
            <input type="email" name="email" placeholder="e.g. example@example.com" class="form-control py-2" required/>
        </div>
    </div>
    <div class="form-group mb-3 row">
        <label for="subject" class="form-label col-md-2 fw-bold text-md-end">Subject:</label>
        <div class="col-md-10">
            <input type="text" name="subject" placeholder="Enter subject" class="form-control py-2" required/>
        </div>
    </div>
    <div class="form-group mb-3 row">
        <label for="message" class="form-label col-12 fw-bold">Message:</label>
        <div class="col-12">
            <textarea name="message" class="form-control" rows="8" style="padding: 0.7rem;" required></textarea>
        </div>
    </div>
    <div class="mb-3">
        <button type="submit" class="btn mt-4 text-white fs-5 fw-bold border-0 py-2 px-md-5 w-100" style="background-image: linear-gradient(90deg, #b743ae, #ed429e);">
            Send
        </button>
    </div>
</form>
